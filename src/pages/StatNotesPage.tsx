...
import { Search, Plus, Trash2, StickyNote, Heart } from "lucide-react";
...
export default function StatNotesPage({ embedded = false }: { embedded?: boolean }) {
    ...
    <div className="flex flex-1 flex-col overflow-y-auto space-y-4">
      ...
      <div className="flex flex-1 flex-col overflow-hidden rounded-xl border border-border bg-card/50">
        <div className="flex items-center gap-2 border-b border-border px-4 py-3">
          ...
          <h3 className="text-sm font-bold text-foreground">Research Notes</h3>
        </div>
  ...
  if (embedded) return <div className="flex flex-1 flex-col overflow-hidden pt-3">{content}</div>;
